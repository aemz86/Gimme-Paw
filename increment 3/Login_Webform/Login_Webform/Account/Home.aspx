...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div data-role="page" id="homepage">
        ...
        <div id="lo" align="right">
            ...
            <br />
            <asp:LinkButton ID="LinkButton1" runat="server" OnClick="viewImages_Click">View Images</asp:LinkButton>

        </div>
        <div align="center"><asp:LinkButton ID="ImgUpload" runat="server" OnClick="ImgUpload_Click" >Upload Images</asp:LinkButton></div>
        <div>
